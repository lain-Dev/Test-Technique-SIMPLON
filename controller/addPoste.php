<?php
    ...
    // On vérifie si le serveur reçoit un POST et si on a cliqué sur le bouton de addPoste
    if (isset($_POST['addPoste'])) {
        ...
        if ($count_crea == 0) { // Si le compteur d'erreur est à 0, on ajoute utilisateur
            ...
            $sql_user = 'INSERT INTO postes (poste) VALUES (:poste)';
            ...
            error_log(date('l jS \of F Y h:i:s A') . ":poste a été créé avec succès\r\n", 3, '../log.txt');

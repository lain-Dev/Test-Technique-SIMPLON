...
<tr>
		<form action="../controller/modifierUser.php" method="POST" style="margin: 0px; padding: 0px;"> 
			...
			<td>
				<input type="text" class="form-control" placeholder="nom" value="<?= htmlspecialchars($user->nom); ?>" name="nom">
			</td>
			<td>
				<input type="text" class="form-control" placeholder="prenom" value="<?= htmlspecialchars($user->prenom); ?>" name="prenom">
			</td>
